    ...
    return (
        ...
        <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-5">
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                <a href="/" class="text-white hover:text-white font-semibold text-xl tracking-tight">MH App</a>
            </div>
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <a href="/community" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                    Community
                </a>
                <a href="/therapists" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
                    Therapists
                </a>
                </div>
                <div>
