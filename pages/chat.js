  ...
  return (
    <Layout home>
      ...
      <div class="chat-form-container">
        <form id="chat-form">
          <input style={{border: "1px solid", borderRadius: "15px", marginLeft: "30px", width: "500px"}}
            id="msg"
            type="text"
            ...
            autocomplete="off"
          />
          <button class="btn" style={{width: "150px", backgroundColor: "lightblue", borderRadius: "15px", marginLeft: "50px"}}><i class="fas fa-paper-plane"></i> Send</button>
        </form>
      </div>
    </div>
