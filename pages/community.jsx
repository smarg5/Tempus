...
class Community extends Component {
  ...
  async getPosts() {
    var body = {}
    const attempt = await axios.post('https://tempusio.herokuapp.com/api/community/getposts', body, {
    });
    this.setState({
 ...
 async submitPost() {
    ...
    await axios.post('https://tempusio.herokuapp.com/api/community/submitpost', body, {
  });
  }
